...
class Mod_Orders(wx.Frame):
    ...
    def FolderA(self, event):
        DirA = wx.DirDialog(self.panel, defaultPath = "/Users/aja/GitHub/TechAcademy_Drills/wxModFileTransfer", pos = (10,30))
        DirA.ShowModal()
        self.pathCO = DirA.GetPath()
        print(self.pathCO)
        self.entry_1.SetValue(self.pathCO)
    def FolderB(self, event):
        DirB = wx.DirDialog(self.panel, defaultPath = "/Users/aja/GitHub/TechAcademy_Drills/wxModFileTransfer", pos = (10,370))
        DirB.ShowModal()
